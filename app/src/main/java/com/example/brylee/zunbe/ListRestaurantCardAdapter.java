...
//    private YelpListHolder restaurants;
    private DatabaseHelper dbHelper;

    public ListRestaurantCardAdapter(Context con, ArrayList<Restaurant> restaurants) {
        this.context = con;
...
//        Restaurant deleteThis = restaurants.getSavedList().get(index);
//        new DeleteFromDB().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, deleteThis);
//        deleteThis.setSaved(false);
//        restaurants.getSavedList().remove(deleteThis);
//        notifyItemRemoved(index);
//    }
//
//    public void removeAll() {
//        if (restaurants.getSavedList() == null) return;
//
//        for (Restaurant r : restaurants.getSavedList())
//            r.setSaved(false);
//
//        int amount = restaurants.getSavedList().size();
//        restaurants.getSavedList().clear();
